    ...
    <div className="min-h-screen pt-24 md:pt-32 pb-12">
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-4xl mx-auto mb-16">
          ...
          <div className="border border-[#e6332a]/30 p-6 sm:p-8 md:p-16 text-center bg-zinc-950/50 shadow-xl">
        ...
        <div className="max-w-4xl mx-auto">
          <div className="border border-[#e6332a]/30 p-8 md:p-12 mb-12 bg-zinc-950/50 shadow-xl">
            <h2 className="text-2xl sm:text-3xl md:text-4xl text-[#e6332a] mb-4 uppercase tracking-[0.15em]">
              Come raggiungere Ekidna
            </h2>
            <div className="h-px w-24 bg-[#e6332a] mb-6"></div>
          ...
          <div className="space-y-6">
            <div className="bg-zinc-950 border border-[#e6332a]/30 hover:border-[#e6332a] hover:shadow-xl transition-all p-8 group">
              <h3 className="text-xl text-[#e6332a] mb-4 uppercase tracking-[0.15em]">1. Abitare là</h3>
            ...
            <div className="bg-zinc-950 border border-[#e6332a]/30 hover:border-[#e6332a] hover:shadow-xl transition-all p-8 group">
              <h3 className="text-xl text-[#e6332a] mb-4 uppercase tracking-[0.15em]">2. In nave</h3>
              <div className="h-px w-16 bg-[#e6332a] mb-4"></div>
              <p className="text-gray-400 leading-relaxed">
            ...
            <div className="bg-zinc-950 border border-[#e6332a]/30 hover:border-[#e6332a] hover:shadow-xl transition-all p-8 group">
              <h3 className="text-xl text-[#e6332a] mb-4 uppercase tracking-[0.15em]">3. In treno</h3>
              <div className="h-px w-16 bg-[#e6332a] mb-4"></div>
              <p className="text-gray-400 leading-relaxed">
            ...
            <div className="bg-zinc-950 border border-[#e6332a]/30 hover:border-[#e6332a] hover:shadow-xl transition-all p-8 group">
              <h3 className="text-xl text-[#e6332a] mb-4 uppercase tracking-[0.15em]">4. In automobile</h3>
              <div className="h-px w-16 bg-[#e6332a] mb-4"></div>
              <p className="text-gray-400 leading-relaxed">
            ...
            <div className="bg-zinc-950 border border-[#e6332a]/30 hover:border-[#e6332a] hover:shadow-xl transition-all p-8 group">
              <h3 className="text-xl text-[#e6332a] mb-4 uppercase tracking-[0.15em]">5. In Nike di Samotracia</h3>
              <div className="h-px w-16 bg-[#e6332a] mb-4"></div>
              <p className="text-gray-400 leading-relaxed">
            ...
            <div className="bg-zinc-950 border border-[#e6332a]/30 hover:border-[#e6332a] hover:shadow-xl transition-all p-8 group">
              <h3 className="text-xl text-[#e6332a] mb-4 uppercase tracking-[0.15em]">6. In corriera</h3>
              <div className="h-px w-16 bg-[#e6332a] mb-4"></div>
              <p className="text-gray-400 leading-relaxed">No.</p>
            </div>

            <div className="bg-zinc-950 border border-[#e6332a]/30 hover:border-[#e6332a] hover:shadow-xl transition-all p-8 group">
              <h3 className="text-xl text-[#e6332a] mb-4 uppercase tracking-[0.15em]">7. Stare a casa</h3>
              <div className="h-px w-16 bg-[#e6332a] mb-4"></div>
              <p className="text-gray-400 leading-relaxed">
            ...
            <div className="bg-zinc-950 border border-[#e6332a]/30 hover:border-[#e6332a] hover:shadow-xl transition-all p-8 group">
              <h3 className="text-xl text-[#e6332a] mb-4 uppercase tracking-[0.15em]">8. Con i droni</h3>
              <div className="h-px w-16 bg-[#e6332a] mb-4"></div>
              <p className="text-gray-400 leading-relaxed">
            ...
            <div className="border-2 border-[#e6332a] p-8 text-center bg-black/60 backdrop-blur-sm shadow-2xl">
              <h3 className="text-xl text-[#e6332a] mb-4 uppercase tracking-[0.15em]">Fine</h3>
              <p className="text-gray-400 mb-4 leading-relaxed">
                Siccome ci siamo sbagliati e abbiamo messo il nostro mezzo preferito al punto 7, finiamo qua.
              </p>
              <div className="h-px w-24 bg-[#e6332a] mx-auto my-6"></div>
              <p className="text-[#e6332a] uppercase tracking-[0.15em]">
