    ...
    <div className="min-h-screen pt-24 md:pt-32 pb-12">
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-4xl mx-auto mb-16">
          ...
          <div className="border border-[#d4a017]/30 p-6 sm:p-8 md:p-16 text-center bg-zinc-950/50 shadow-xl">
        ...
        <div className="max-w-4xl mx-auto">
          <div className="border border-[#d4a017]/30 p-8 md:p-12 mb-12 bg-zinc-950/50 shadow-xl">
            <h2 className="text-2xl sm:text-3xl md:text-4xl text-[#d4a017] mb-4 uppercase tracking-[0.15em]">
              Come raggiungere Ekidna
            </h2>
